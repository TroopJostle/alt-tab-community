...
///
/// Gating note: the caller passes `canSearch` as a plain Bool (always `true` in the app today — the
/// historical Pro gate was removed); the kernel just routes on it. `toggle` is gate-free because the
